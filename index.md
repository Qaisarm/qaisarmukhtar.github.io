...
<body>
    ...
    <section class="section about" id="about">
        ...
        <div class="about-img">
            <img src="./assets/images/me.jpeg" alt="Qaisar Mukhtar">
        </div>
        ...
        <div class="about-content">
            ...
            <div class="about-tabs">
                ...
                <div class="tab-contents skills" id="skills">
        ...
        <h1 class="display-4">Tech I'm familiar with</h1>
            <div class="row pt-5">
                 ...
                 <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                    <div class="icon-box">
                        <img class="tech-icon" src="assets/images/icons/java.png">
                        <h3>Java</h3>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                    <div class="icon-box">
                        <img class="tech-icon" src="assets/images/icons/python.png">
                        <h3>Python</h3>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                    <div class="icon-box">
                        <img class="tech-icon" src="assets/images/icons/c.png">
                        <h3>C</h3>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                    <div class="icon-box">
                        <img class="tech-icon" src="assets/images/icons/html.png">
                        <h3>HTML</h3>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                ...
                <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                    <div class="icon-box">
                        <img class="tech-icon" src="assets/images/icons/bootstrap.png">
                        <h3>Bootstrap</h3>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                ...
                <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                    <div class="icon-box">
                        <img class="tech-icon" src="assets/images/icons/react.png">
                        <h3>React</h3>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                ...
                <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                    <div class="icon-box">
                        <img class="tech-icon" src="assets/images/icons/ts.png">
                        <h3>Typescript</h3>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
        ...
        <div class="works">
            ...
            <div class="all-works project-content">
                ...
                <div class="project-card hidden-card">
                    <img src="./assets/images/projects/sci.PNG" alt="SCI" class="project-img">
                    <div class="card-content">
                ...
                <div class="project-card hidden-card">
                    <img src="./assets/images/projects/weather.png" alt="Weather" class="project-img">
                    <div class="card-content">
                        <h4>Weather API</h4>
                        <h5><i class="website-i"></i>Web App</h5>
                ...
                <div class="project-card hidden-card">
                    <img src="./assets/images/projects/port.PNG" alt="Portfolio" class="project-img">
                    <div class="card-content">
                        <h4>Portfolio</h4>
                        <h5><i class="website-i"></i>Web App</h5>
                        <p>My portfolio.</p>
...
<!---section id=communities>
    <div class=container>
        <h2 class=section-title>Communities Involved With</h2>
        <div class=communities-content>
            <span><img src=assets/openrefine.3cd054c6c1052017a2f0a2c10dfbbdc4.png class="img-fluid icon-size" alt=img></span>
            <span><img src=assets/anitaborg.9e34b44453fd48462405003f468de82a.png class="img-fluid icon-size" alt=img></span>
            <span><img src=assets/cfclogo.11544caa2c6a1d011bae6865492a9fe4.png class="img-fluid icon-size" alt=img></span>
            <span><img src=assets/jboss.fd605ab04eb6a2913f4acdc105a3ca8f.png class="img-fluid icon-size" alt=img></span>
            <span><img src=assets/codingjunior.740cdc78fe0f11ff7fb038a0de573131.png class="img-fluid icon-size" alt=img></span>
            <span><img src=assets/codeAttack.6a35aaf580973f9c71ce157fc701ebb5.png class="img-fluid icon-size" alt=img>
    </span>
    </div>
    </div>
    </section-->
